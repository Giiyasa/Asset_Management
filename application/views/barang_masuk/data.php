                ...
                if ($barangmasuk) :
                    foreach ($barangmasuk as $bm) :
                        ...
                        <tr>
                            ...
                            <td><?= $bm['nama']; ?></td>
                            <td>
                                <a onclick="return confirm('You sure about it?')" href="<?= base_url('barangmasuk/delete/') . $bm['id_barang_masuk'] ?>" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
